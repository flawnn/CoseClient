...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public EntityPlayer(World worldIn, GameProfile p_i45324_2_)
    {
        ...
        this.inventoryContainer = new ContainerPlayer(this.inventory, (worldIn == null ? true : !worldIn.isRemote), this);
        this.openContainer = this.inventoryContainer;
        BlockPos var3 = (worldIn == null ? new BlockPos(0, 0, 9) : worldIn.getSpawnPoint());
        this.setLocationAndAngles((double)var3.getX() + 0.5D, (double)(var3.getY() + 1), (double)var3.getZ() + 0.5D, 0.0F, 0.0F);
        this.field_70741_aB = 180.0F;
        this.fireResistance = 20;
    }
    
    public EntityPlayer(boolean isFake)
    {
    	super(isFake);
    	gameProfile = null;
    }
