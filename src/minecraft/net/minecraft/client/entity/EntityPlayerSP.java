...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public EntityPlayerSP(Minecraft mcIn, World worldIn, NetHandlerPlayClient playClient, StatFileWriter statWriter)
    {
        super(worldIn, playClient.func_175105_e());
        this.sendQueue = playClient;
