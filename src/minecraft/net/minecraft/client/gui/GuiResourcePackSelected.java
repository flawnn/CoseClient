...
public class GuiResourcePackSelected extends GuiResourcePackList
{
    ...
    public GuiResourcePackSelected(Minecraft mcIn, int p_i45056_2_, int p_i45056_3_, List p_i45056_4_, boolean aaa)
    {
        super(mcIn, p_i45056_2_, p_i45056_3_, p_i45056_4_, aaa);
    }
