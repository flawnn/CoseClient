...
import net.minecraft.command.YoutuberCommand;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void func_175281_b(String command, boolean p_175281_2_)
    {
    	boolean ignoreQueque = false;
    	String label = command.split(" ")[0];
    	if(label.equalsIgnoreCase("/youtube") || label.equalsIgnoreCase("/yt"))
    	{
    		YoutuberCommand cmd = new YoutuberCommand();
    		try {
