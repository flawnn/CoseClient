...
public class GuiResourcePackAvailable extends GuiResourcePackList
{
    ...
    public GuiResourcePackAvailable(Minecraft mcIn, int p_i45054_2_, int p_i45054_3_, List p_i45054_4_, boolean aaa)
    {
        super(mcIn, p_i45054_2_, p_i45054_3_, p_i45054_4_, aaa);
    }
