...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(float p_175180_1_)
    {
        ...
        {
        	mc.mcProfiler.startSection("cose.functions_keybinds");
        	if(!Options.inChatModus)
        	{
	            if(mc.delayKeyBindMuschel > 0)
	            	mc.delayKeyBindMuschel --;
	            else if(mc.gameSettings.isKeyDown(mc.gameSettings.keyBindMagischeMiesmuschel))
	            {
	            	if(!mc.prevKeyBindMuschel)
	            	{
	            		mc.prevKeyBindMuschel = true;
	            		String message = "";
	            		String[] antworten = new String[] {"Ja", "Nein", "Vielleicht", "Eher nicht", "Na klar", "Auf jeden Fall", "Warscheinlich", "Sicher doch", "M�glich", "Was denkst du denn?", "Nicht wirklich", "Niemals", "Was hast du denn f�r Gedanken?!", "Sicherlich nicht", "Ganz bestimmt nicht", "Wie kommst du darauf?", "�berlastet", "Vergiss es!", "Nie im leben", "Frag einfach nochmal!", "Beim n�chsten mal vielleicht", "Doofe Frage", "Was geht dich das an?", "Ganz bestimmt"};
	            ...
	            else if(mc.prevKeyBindMuschel)
	            	mc.prevKeyBindMuschel = false;
        	}
        }
