...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    /** Previous Cose Functions Key Bind Down + Delay Timer*/
    public boolean prevKeyBindMuschel = false;
    public int delayKeyBindMuschel = 0;
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle(Core.minecraftVersion);
