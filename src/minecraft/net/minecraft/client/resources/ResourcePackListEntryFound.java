...
public class ResourcePackListEntryFound extends ResourcePackListEntry
{
    ...
    public ResourcePackListEntryFound(GuiScreenResourcePacks p_i45053_1_, ResourcePackRepository.Entry p_i45053_2_, boolean textureMode)
    {
        super(p_i45053_1_, textureMode);
    ...
    public ResourcePackListEntryFound(GuiScreenTexturesPacks p_i45053_1_, ResourcePackRepository.Entry p_i45053_2_)
    {
        super(p_i45053_1_);
        this.field_148319_c = p_i45053_2_;
    }
