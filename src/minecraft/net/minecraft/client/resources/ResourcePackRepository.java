...
public class ResourcePackRepository
{
    ...
    private final File dirTexturespacks;
    ...
    public ResourcePackRepository(File p_i45101_1_, File p_i45101_2_, IResourcePack p_i45101_3_, IMetadataSerializer p_i45101_4_, GameSettings p_i45101_5_)
    {
        ...
        this.dirTexturespacks = new File(dirResourcepacks.toPath().toString().substring(0, dirResourcepacks.toPath().toString().length()-13) + "versions\\Cose");
        this.field_148534_e = p_i45101_2_;
        this.rprDefaultResourcePack = p_i45101_3_;
        this.rprMetadataSerializer = p_i45101_4_;
        this.fixDirResourcepacks();
        this.fixDirTexturepackspacks();
        this.updateRepositoryEntriesAll_All();
    ...
    private void fixDirTexturepackspacks()
    {
        if (!this.dirTexturespacks.isDirectory() && (!this.dirTexturespacks.delete() || !this.dirTexturespacks.mkdirs()))
        {
            field_177320_c.debug("Unable to create resourcepack folder: " + this.dirTexturespacks);
        }
    }
    ...
    private List getTexturespacksFiles()
    {
        return this.dirTexturespacks.isDirectory() ? Arrays.asList(this.dirTexturespacks.listFiles(resourcePackFilter)) : Collections.emptyList();
    }
    
    public void updateRepositoryEntriesAll_All()
    {
        ArrayList var1 = Lists.newArrayList();
        Iterator var2 = this.getResourcePackFiles().iterator();
        Iterator var2_ = this.getTexturespacksFiles().iterator();
    ...
    public void updateRepositoryEntriesAll_Resource()
    {
        ArrayList var1 = Lists.newArrayList();
        Iterator var2 = this.getResourcePackFiles().iterator();
    ...
    public void updateRepositoryEntriesAll_Textures()
    {
        ArrayList var1 = Lists.newArrayList();
        Iterator var2 = this.getTexturespacksFiles().iterator();
    ...
    public File getDirTexturespacks()
    {
        return this.dirTexturespacks;
    }
    ...
    public class Entry
    {
        ...
        public Entry(File p_i1296_2_, Object p_i1296_3_)
        {
            this(p_i1296_2_);
        }
    }
