...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 2 + this.field_175353_i / 2 + this.fontRendererObj.FONT_HEIGHT + 22, "Rejoin"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 1)
        {
        	mc.displayGuiScreen(new GuiConnecting(parentScreen, mc, Core.ramServerData));
        }
    }
