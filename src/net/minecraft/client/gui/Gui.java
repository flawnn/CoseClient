...
public class Gui
{
    ...
    public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height)
    {
        ...
        var3.addVertexWithUV((double) (x + 0)		, (double) (y + height)	, (double) this.zLevel, (double) ((float) (textureX + 0) * var0)	, (double) ((float) (textureY + height) * var1));
        var3.addVertexWithUV((double) (x + width)	, (double) (y + height)	, (double) this.zLevel, (double) ((float) (textureX + width) * var0), (double) ((float) (textureY + height) * var1));
        var3.addVertexWithUV((double) (x + width)	, (double) (y + 0)		, (double) this.zLevel, (double) ((float) (textureX + width) * var0), (double) ((float) (textureY + 0) * var1));
        var3.addVertexWithUV((double) (x + 0)		, (double) (y + 0)		, (double) this.zLevel, (double) ((float) (textureX + 0) * var0)	, (double) ((float) (textureY + 0) * var1));
        var2.draw();
    }
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(int x, int y, float textureX, float textureY, int width, int height, float textureWidth, float textureHeight)
    {
        float var0 = 1.0F / textureWidth;
        float var1 = 1.0F / textureHeight;
        Tessellator var2 = Tessellator.getInstance();
        WorldRenderer var3 = var2.getWorldRenderer();
        var3.startDrawingQuads();
        var3.addVertexWithUV((double) (x + 0)		, (double) (y + height)	, 0.0D, (double) ((textureX + 0) * var0)				, (double) ((textureY + (float) height) * var1));
        var3.addVertexWithUV((double) (x + width)	, (double) (y + height)	, 0.0D, (double) ((textureX + (float) width) * var0)	, (double) ((textureY + (float) height) * var1));
        var3.addVertexWithUV((double) (x + width)	, (double) (y + 0)		, 0.0D, (double) ((textureX + (float) width) * var0)	, (double) ((textureY + 0) * var1));
        var3.addVertexWithUV((double) (x + 0)		, (double) (y + 0)		, 0.0D, (double) ((textureX + 0) * var0)				, (double) ((textureY + 0) * var1));
        var2.draw();
    }
