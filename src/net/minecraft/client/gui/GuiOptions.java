...
import me.cose.gui.options.CoseOptionsMenu;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(134, this.width / 2 - 75, this.height / 6 + 48 - 33, 150, 20, "Cose Optionen"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
        	if (button.id == 134)
        	{
        		mc.displayGuiScreen(new CoseOptionsMenu(this));
        	}
