...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        copyAnglesFromFirstToSecond(this.bipedHead, this.bipedHeadwear);
        if(SkinManager.currentHat != null)
        	if(SkinManager.currentHat.shallRender((EntityLivingBase) p_78087_7_))
        		copyAnglesFromFirstToSecond(this.bipedHead, SkinManager.currentHat.renderer);
    }
