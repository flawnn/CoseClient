...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    protected final GuiScreenTexturesPacks field_148315_c;
    private static final String __OBFID = "CL_00000821";
    private final boolean textureMode;
    
    public ResourcePackListEntry(GuiScreenResourcePacks p_i45051_1_, boolean textureMode)
    {
    ...
    public ResourcePackListEntry(GuiScreenTexturesPacks p_i45051_1_)
    {
        this.field_148315_c = p_i45051_1_;
        this.field_148317_a = Minecraft.getMinecraft();
        field_148315_b = null;
        this.textureMode = false;
    }
